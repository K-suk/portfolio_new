    ...
    return (
        ...
        >
            ...
            <VStack align="start" maxW="600px" p={4}>
                ...
                <Text color="gray.300">
                    現在カナダのブリティシュコロンビア大学でコンピューターサイエンスを専攻しています。大学ではassemblyや機械言語からアルゴリズムまではば広く全体的にコンピューターサイエンスを学んでいます。<br />
                    個人開発では、主にDjangoとNext.jsを使用し、Webアプリケーションの開発を行っています。訪日外国人向けのツアーを企画から運営まで一貫して行っており、企画力、実行力には自信があります。<br />
